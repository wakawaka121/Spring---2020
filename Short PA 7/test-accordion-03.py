...
""" Code to test the accordion_recursive() function
...
nodes   = [ list_node.ListNode("first"),
            list_node.ListNode("second"),
            list_node.ListNode("third"),
            list_node.ListNode("fourth"),
            list_node.ListNode("5th"),
            list_node.ListNode(6),
            list_node.ListNode("siete"),
            list_node.ListNode("1000_binary"),
            list_node.ListNode("the_second_square"),  ]
in_list = nodes[0]
...
###########################################################
def main():
    print("Testing accordion_recursive()...")
    print()
    print(f"Input list: {in_list}")

    out_list = linked_list_recursion.accordion_recursive(in_list)
